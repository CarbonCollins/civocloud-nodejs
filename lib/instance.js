...
const instanceMixin = (SuperClass) => {
  ...
  return class InstanceAPI extends SuperClass {
     ...
     * @description gets an array of the instances on civo cloud
     ...
     * @description creates a new instance network in civo
     ...
     * @description deletes an existing instance within civo
     ...
     * @description gets an existing instance from civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @description updates the tags on an existing instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @param {Object} [options] an optional options object
     ...
     * @description reboots an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @see {@link https://www.civo.com/api/instances#rebooting-an-instance}
     * @description hard reboots an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @see {@link https://www.civo.com/api/instances#rebooting-an-instance}
     * @description soft reboots an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @description stops (shutdown) an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @description starts an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @description resizes an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     ...
     * @description rebuilds an instance in civo
     * @param {String} id the instance id to be used to identify the instance in civo
     * @returns {Promise} a promise wich resolves with the result or rejects with an error
     * @public
     */
     ...
     * @description restores an instance in civo from a snapshot
     * @param {String} id the instance id to be used to identify the instance in civo
     ...
     * @description Applies a firewall to an instance
     * @param {String} id the instance id to be used to identify the instance in civo
     * @param {Object} [options] an optional options object
     ...
     * @description Moves an owned public ip address from one instance you own to another instance
     * @param {String} id the instance id to be used to identify the instance in civo
