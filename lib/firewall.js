...
const firewallMixin = (SuperClass) => {
  ...
  return class FirewallAPI extends SuperClass {
     ...
     * @description gets an array of the firewalls on civo account
     ...
     * @description creates a new firewall in civo
     ...
     * @description deletes an existing firewall within civo
     ...
     * @description gets an array of the firewalls rules on civo account
     * @param {String} id the firewalls id to be used to identify the network in civo
     * @returns {Promise} a promise wich resolves with the foirewall list or rejects with an error
     * @public
     */
     ...
     * @description creates a new firewall rule within an existing firewall
     ...
     * @description deletes an existing firewall rule within a firewall
