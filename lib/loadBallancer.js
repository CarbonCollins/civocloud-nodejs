...
const loadBallancerMixin = (SuperClass) => {
  /**
   * @mixin LoadBallancerAPI
   */
  return class LoadBallancerAPI extends SuperClass {
    /**
     * @method LoadBallancerAPI~listLoadBalancers
     * @see {@link https://www.civo.com/api/loadbalancer#list-load-balancers}
     * @description Lists all of the available load ballancers on the civo account
    ...
    /**
     * @method LoadBallancerAPI~createLoadBalancer
     * @see {@link https://www.civo.com/api/loadbalancer#setup-a-new-load-balancer}
     * @description Creates a new load ballancer on the civo account
    ...
    createLoadBalancer(hostname, backends, options) {
      ...
      return this.__postRequest('loadbalancers', payload);
    }

    /**
     * @method LoadBallancerAPI~updateLoadBalancer
     * @see {@link https://www.civo.com/api/loadbalancer#update-a-load-balancer}
     * @description updates an existing load ballancer with new information
    ...
    updateLoadBalancer(id, options) {
      ...
      return this.__putRequest(`loadbalancers/${id}`, payload);
    }

    /**
     * @method LoadBallancerAPI~deleteLoadBalancer
     * @see {@link https://www.civo.com/api/loadbalancer#deleting-a-load-balancer}
     * @description deletes an existing load ballancer from the civo account
